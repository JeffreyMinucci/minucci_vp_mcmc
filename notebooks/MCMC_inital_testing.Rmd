...
system.time(test_results <- new_vp_mcmc_c(nsims = 20, step_length = .25, vp_dir=vpdir, static_vars = static_list, 
                            optimize_vars = optimize_list, logs = T, verbose = T))[3]
str(test_results)
print(paste("Acceptance rate:", test_results$accept_rate))
#save(test_results,file=paste(vpdir_output,"mcmc_run_objects/test_2_20_18.Rdata",sep = ""))
