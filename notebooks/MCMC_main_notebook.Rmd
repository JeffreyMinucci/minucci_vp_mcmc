...
system.time(test_results <- new_vp_mcmc_c(nsims = 10, step_length = .1, vp_dir=vpdir, static_vars = static_list, 
...
```{r}
test_results <- readRDS(file=paste(vpdir,"output/mcmc_run_objects/run_5_2_18.rds",sep = ""))
print(paste("Acceptance rate:", test_results$accept_rate))
```
