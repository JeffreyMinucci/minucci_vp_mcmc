...
for(i in 1:20){
  ...
  saveRDS(test_results,file=paste(vpdir,"output/mcmc_run_objects/run_5_11_18_p3.rds",sep = ""))
}
...
MCMCtrace(results_bt2,filename="test6_265k_thin1k_burn50k",
          iter=265000,wd=paste(vpdir,"reports/figures/",sep="")) #creates pdf in reports/figures folder
