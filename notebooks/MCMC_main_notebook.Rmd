...
saveRDS(test_results,file=paste(vpdir,"output/mcmc_run_objects/run_3_28_18_p6.rds",sep = ""))
test_results <- continue_vp_mcmc(50000,test_results,step_length = .2)
saveRDS(test_results,file=paste(vpdir,"output/mcmc_run_objects/run_3_28_18_p6.rds",sep = ""))
...
par(mfrow=c(1,1))
MCMCtrace(as.matrix(test_results$param_trace[, test_results$mcmc_params$optimize_vars[["names"]]]),filename="test_245k_last150",
          iter=150000,wd=paste(vpdir,"reports/figures/",sep="")) #creates pdf in reports/figures folder
