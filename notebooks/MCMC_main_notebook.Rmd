...
```{r}
test_results <- readRDS(file=paste(vpdir,"output/mcmc_run_objects/run_5_11_18_p2.rds",sep = ""))
print(paste("Acceptance rate:", test_results$accept_rate))
```
...
results_bt <- burnAndThin(results,burn=20000,thin=100)
results_bt2 <- burnAndThin(results,burn=20000,thin=1000)
...
MCMCtrace(results,filename="test4_65k",
          iter=65000,wd=paste(vpdir,"reports/figures/",sep="")) #creates pdf in reports/figures folder

MCMCtrace(results_bt,filename="test4_65k_thin100",
          iter=65000,wd=paste(vpdir,"reports/figures/",sep="")) #creates pdf in reports/figures folder


MCMCtrace(results_bt2,filename="test6_65k_thin1000",
