...
============================
Note: koc and kow will only have an effect when pesticide exposure is implemented.
```{r}
...
===================================
Note: Pollen and nectar trips per day will have no effect until pesticide exposure is implemented.
```{r}
