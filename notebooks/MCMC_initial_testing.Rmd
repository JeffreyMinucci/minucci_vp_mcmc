...
system.time(test_results <- new_vp_mcmc_c(nsims = 2, step_length = .5, vp_dir=vpdir, static_vars = static_list, 
...
test_results <- continue_vp_mcmc(3,test_results,step_length = .6)
plot(test_results$like_trace,type='l')
