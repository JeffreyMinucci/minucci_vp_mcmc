...
test_that("Txt files created and all given parameters included", {
  ...
  expect_equal(nrow(result_1),9+ncol(input_df_3))
  expect_equal(result_1[10,1], "SimEnd=8/25/2015")
  expect_equal(result_10[10,1], "SimEnd=8/25/2015")
  expect_equal(result_1[12,1], "three=5")
  expect_equal(result_10[12,1], "three=5")
  ...
  result_1 <- read.table(paste(vpdir_testin,"input_mcmc_1.txt",sep=""),stringsAsFactors = F)
  result_10 <- read.table(paste(vpdir_testin,"input_mcmc_10.txt",sep=""),stringsAsFactors = F)
  expect_equal(nrow(result_1),9+ncol(input_df_1))
  expect_equal(result_1[10,1], "SimEnd=8/25/2015")
  expect_equal(result_10[10,1], "SimEnd=8/25/2015")
